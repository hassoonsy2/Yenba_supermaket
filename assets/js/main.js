// Use module syntax to import Three.js components
...
function initialize3DModelViewer(containerId, modelPath) {
    ...
    loader.load(
        ...
        function (gltf) {
            ...
            model.position.set(0, 3, 1); // Adjust position if needed
            scene.add(model);
...
initialize3DModelViewer('simit-3d-order-container', 'assets/images/Turkish_simit_1115163756_refine.glb');
